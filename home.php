  ...
  <body>
    ...
    <main class="section-main">
        ...
        <div class="section-ride--svg">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path
              fill="#DFC47F"
              fill-opacity="1"
              d="M0,224L48,224C96,224,192,224,288,192C384,160,480,96,576,64C672,32,768,32,864,53.3C960,75,1056,117,1152,128C1248,139,1344,117,1392,106.7L1440,96L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"
            ></path>
          </svg>
        </div>
      </section>
                ...
                <li class="splide__slide relative">
                  <div class="slideshow__slide">
                    ...
                    <div class="slideshow__slide--info">
                      <h2 class="heading-primary">Meet the hill Champion!</h2>
                      <p class="paragraph">
                        Take on those hills with the brand new E-Klimber and
                        dominate them
                      </p>
                      <p>at only KES 29,999</p>
                      <button
                        class="
                          btn btn-grey
      ...
      <section class="section-testimonials" id="testimonials">
        ...
        <!-- <div class="slide">
          <div id="#splide" data-splide='{"speed": 1000 ,"perPage": 2}'>
            <div class="splide__slider  ">
              <div class="splide__track">
                <ul class="splide__list">
                  <li class="splide__slide relative quote">
                    <div class="slide__card ">
                      <div class="splide__slide__container slide__image">
                        <img src="./assets/images/bike.jpg" alt="" srcset="">
                      </div>
          ...
          <div class="center">
            <div class="contact__details">
              ...
              <div class="contact__details--email">
                ...
                <a class="email" href="mailto:info@ecycle.com"
                  >info@ecycle.com</a
                >
              </div>
